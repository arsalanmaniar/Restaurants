    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "menu names when available, otherwise the cuisine text). A "
                "zero result comes back with `found_anywhere: false` and a "
                "`note` — the search already covered EVERY open restaurant, "
                "so tell the customer plainly that the dish is not available "
                "at any of our restaurants. Do NOT call list_restaurants to "
                "paper over it, and do NOT name a restaurant. Follow the "
                "`note` in the result.\n\n"
